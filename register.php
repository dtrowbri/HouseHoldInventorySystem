...
?>
	<div class="d-flex text-center bg-secondary">  
    	<form class="form-login" action="registerHandler.php" method="post" oninput="password2.setCustomValidity(password2.value != password.value ? 'Passwords do not match.' : '')">
            ...
            <button class="btn btn-lg btn-primary btn-block mb-2 mt-2" type="submit">Register</button>

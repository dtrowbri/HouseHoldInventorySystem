...
?>
  <div class="d-flex text-center bg-secondary">  
    <form class="form-login" action="loginHandler.php" method="post">
        ...
        <h1 class="h3 mb-3 font-weight-normal">Login Form:</h1>
          <input type="text" class="form-control mb-2 ip-2" id="username" name="username" placeholder="username" required autofocus />
